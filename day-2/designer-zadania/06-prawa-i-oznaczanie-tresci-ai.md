...
2. Sprawdź, co się stanie z metadanymi po wysłaniu pliku przez komunikator
   lub wrzuceniu na portal społecznościowy – wgraj go ponownie do
   weryfikatora. Czy oznaczenie przetrwało?
3. Sformułuj **jedno zdanie**, którym oznaczysz materiał w publikacji,
...
4. Przeanalizujcie w grupie cztery sytuacje – w każdej odpowiedzcie: wolno,
...
5. Sprawdź w [warunkach usługi Microsoft](https://www.microsoft.com/servicesagreement),
...
6. Zapisz dla siebie krótką zasadę: **czego nigdy nie wpiszesz w opis obrazu**
...
- Która z czterech sytuacji z punktu 4 wywołała największą różnicę zdań
  w grupie i dlaczego?
